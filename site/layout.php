                    ...
                    <div class="row">
                        <div class="col-3">
                            <a href="#" class="logo-wrapper">
                                <img src="../public/img/logo1.jpg" class="img-fluid" width="50%" alt="">
                            </a>
                        </div>
                           ...
                           <div class="row">
                                <div class="col-3">
                                   <div class="row">
                                        <div class="col-4">
                                            <a href="#" class="logo-wrapper">
                                                <img src="../public/img/icon/chuyenhang.png" alt="" width="80%">
                                ...
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#" class="logo-wrapper">
                                                <img src="../public/img/icon/thu.png" alt="" width="80%">
                                ...
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#" class="logo-wrapper">
                                                <img src="../public/img/icon/dongho.png" alt="" width="80%">
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="../public/img/banner/banner 1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../public/img/banner/banner2.jpg" class="d-block w-100" alt="...">
                            </div>
